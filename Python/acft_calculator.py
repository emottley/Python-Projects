...
#Deadlift with Admin
with open('Python/acft/acft_raw_deadlift.txt', 'r') as file:
...
with open('Python/acft/acft_raw_power_throw.txt', 'r') as file:
    score_arr = []
    lines = file.readlines()
    i = 0
    for line in lines:
...
#Pushup
with open('Python/acft/acft_raw_pushup.txt', 'r') as file:
    score_arr = []
    i = 1
    lines = file.readlines()
    for line in lines:
...
#Plank
with open('Python/acft/acft_raw_plank.txt', 'r') as file:
    score_arr = []
    i = 1
    lines = file.readlines()
    for line in lines:
...
#Sprint
with open('Python/acft/acft_raw_sprint_drag_carry.txt', 'r') as file:
    score_arr = []
    i = 1
    lines = file.readlines()
    for line in lines:
...
#Run
with open('Python/acft/acft_raw_run.txt', 'r') as file:
    score_arr = []
    i = 1
    lines = file.readlines()
    for line in lines:
